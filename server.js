...
app.post('/api/scan', async (req, res) => {
  ...
  const queries = [
    'Nordic logistics warehouse expansion Sweden Denmark Finland 2025 2026 new facility lease contract DSV PostNord Bring Schenker Stockholm Gothenburg Malmö',
  ];
    ...
    try {
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          system: `You are a Nordic logistics real estate market analyst. Search for recent news and return ONLY a raw JSON array.
Each item: {"title":"headline","description":"2-3 sentence summary","link":"url","date":"YYYY-MM-DD","company":"main company","country":"sweden|denmark|finland|unknown","region":"city or unknown"}
Return 8-12 most relevant recent items. Raw JSON array only — no markdown, no preamble.`,

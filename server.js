...
app.post('/api/scan', async (req, res) => {
  ...
  const queries = [
    ...
    'DSV PostNord Bring DB Schenker logistics Sweden warehouse expansion 2025 2026',
    'Stockholm Gothenburg Malmö Jönköping logistics warehouse distribution center new lease 2025 2026',
  ];

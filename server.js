    ...
    try {
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          system: `Nordic logistics RE analyst. Search and return ONLY a JSON array, max 8 items: [{"title":"...","description":"...","link":"...","date":"YYYY-MM-DD","company":"...","country":"sweden|denmark|finland","region":"city"}]. Raw JSON only.`,

...
app.post('/api/scan', async (req, res) => {
  ...
  const queries = [
    'Nordic logistics transport warehouse expansion lease contract 2025 2026 Sweden Denmark Finland new facility terminal',
  ];
    ...
    try {
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          system: `Nordic logistics RE analyst. Priority companies: ${companyList}. Search news about these companies and Nordic logistics/warehouse expansion. Return ONLY a JSON array, max 10 items: [{"title":"...","description":"...","link":"...","date":"YYYY-MM-DD or null","company":"...","country":"sweden|denmark|finland","region":"city"}]. Use null for date if not found in source. Raw JSON only.`,
      ...
      if (!match) { console.warn('No JSON array found in response'); continue; }

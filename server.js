...
app.post('/api/scan', async (req, res) => {
  ...
  const queries = [
    'Nordic logistics warehouse expansion Sweden Denmark Finland 2025 2026 new facility lease contract',
    'DSV PostNord Bring DB Schenker DHL logistics Sweden warehouse expansion 2025 2026',
    'Stockholm Gothenburg Malmö logistics warehouse distribution center new lease opening 2025 2026',
    'Jönköping Helsingborg Norrköping logistics industrial real estate expansion 2025 2026',
    'Copenhagen Aarhus Helsinki logistics warehouse expansion contract 2025 2026',
  ];
